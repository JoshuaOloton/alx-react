...
describe("Selectors tests", function () {
  it("tests that filterTypeSelected works as expected", function () {
  ...
  it("tests that getNotifications returns a list of the message entities within the reducer", function () {
    const initialState = {
      filter: "DEFAULT",
      notifications: [
        {
  ...
  it("tests that getUnreadNotificationsByType returns a list of the message entities within the reducer", function () {
    const state = {
  ...
  it("verifies that the selector returns unread urgent notifications when the filter is set", function () {
    const state = {
      notifications: fromJS({
        filter: "URGENT",
        messages: {
